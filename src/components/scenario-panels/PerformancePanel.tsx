    ...
    <Drawer open={open} onOpenChange={onClose}>
      <DrawerContent className="w-full md:w-[700px] max-w-[90vw] bg-white border-l border-gray-200 overflow-y-auto">
        <div className="flex justify-between items-center p-6 pb-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-800">Performance & Benchmark Details</h2>
          <button onClick={onClose} className="p-2 rounded-full hover:bg-gray-100">
            <X className="w-5 h-5 text-gray-500" />
          </button>
        </div>
        <div className="p-6">
          <div className="text-sm text-gray-500 mb-4">Environmental and performance metrics with detailed charts.</div>
