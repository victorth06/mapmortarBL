...
export function FinancePanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <Drawer open={open} onOpenChange={onClose}>
      <DrawerContent className="w-full md:w-[600px] max-w-[90vw] bg-white border-l border-gray-200 overflow-y-auto">
        ...
        <div className="p-6">
          <div className="text-sm text-gray-500 mb-4">Detailed financial metrics and cashflow analysis.</div>
